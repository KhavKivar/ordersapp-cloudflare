...
CREATE TABLE "purchase_orders" (
    "id" INTEGER PRIMARY KEY AUTOINCREMENT,
    "status" TEXT DEFAULT 'pending' NOT NULL CHECK("status" IN ('pending', 'received', 'paid', 'cancelled')),
...
CREATE TABLE "orders" (
    ...
    "status" TEXT DEFAULT 'pending' NOT NULL CHECK("status" IN ('pending', 'paid', 'delivered', 'delivered_paid', 'cancelled')),
    "created_at" DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL
);
